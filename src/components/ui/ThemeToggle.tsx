...
export default function ThemeToggle() {
    ...
    return (
        ...
        >
            {isDark ? (
                <FontAwesomeIcon icon={faSun} className="h-5 w-5 text-yellow-400" aria-hidden="true"/>
            ) : (
                <FontAwesomeIcon icon={faMoon} className="h-5 w-5 text-zinc-300" aria-hidden="true"/>
            )}
        </button>
    );
}